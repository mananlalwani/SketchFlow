...
export const SUPPORTED_DRAWINGS: DrawingKind[] = [
  'rectangle',
  'triangle',
  'circle',
  'ellipse',
...
export function closedDrawingPriority(type: string): number {
  switch (type) {
    case 'rectangle':
      return 4;
    case 'triangle':
...
export function isRectangle(vertices: Point[]): { score: number; error: number } | null {
...
export function rectangleEdgeFit(
  points: Point[],
  box: BoundingBox,
...
export function simplifyClosedPath(points: Point[], tolerance: number): Point[] {
...
export function hasPolygonIntent(vertices: Point[]): boolean {
...
export function triangleVerticesFromTurns(points: Point[], diagonal: number): Point[] | null {
...
export function triangleEdgeFit(
  points: Point[],
  vertices: Point[],
  diagonal: number,
...
export function parabolaCandidate(
  points: Point[],
  box: BoundingBox,
  thresholds: DetectionThresholds,
): DetectionResult | null {
