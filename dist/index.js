...
import { requestIdMiddleware, requestLoggingMiddleware, securityHeadersMiddleware, rateLimitMiddleware, errorHandlerMiddleware, } from './middleware/index.js';
...
class LiveDrawServer {
    ...
    setupRoutes() {
        ...
        this.app.get('/api/projects', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
        ...
        this.app.get('/api/projects/:id', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            const userId = req.auth.userId;
        ...
        this.app.post('/api/projects', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.put('/api/projects/:id', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
                const { title, data } = req.body || {};
        ...
        this.app.delete('/api/projects/:id', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.post('/api/projects/:id/share', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.post('/api/projects/:id/unshare', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.get('/api/projects/:id/collaborators', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
                ...
                const enrichedCollaborators = await Promise.all(collaborators.map(async (c) => {
                    try {
        ...
        this.app.post('/api/projects/:id/collaborators', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.delete('/api/projects/:id/collaborators/:collaboratorUserId', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.post('/api/projects/:id/move', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        // Folder APIs
        this.app.get('/api/folders', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.post('/api/folders', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
        ...
        this.app.put('/api/folders/:id', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
                const { name, color, parentId } = req.body || {};
        ...
        this.app.delete('/api/folders/:id', requireAuth(), requireAuthMiddleware(), async (req, res) => {
            try {
                const userId = req.auth.userId;
    ...
    setupSocketHandlers() {
        ...
        this.io.on('connection', (socket) => {
            ...
            socket.on('draw:strokes', async (strokes) => {
            ...
            // Handle shapes
            socket.on('draw:shape', async (shape) => {
            ...
            socket.on('canvas:snapshot', (snapshot) => {
