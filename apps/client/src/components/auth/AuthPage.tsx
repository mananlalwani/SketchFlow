...
import { Loader2, LockKeyhole, Mail, PenTool } from 'lucide-react';
...
function AuthForm({ mode }: { mode: AuthMode }) {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f6f2e9] px-4 py-8 text-stone-950 dark:bg-[#171513] dark:text-stone-50">
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-stone-200/80 bg-stone-50 p-6 shadow-xl shadow-stone-950/10 dark:border-white/[0.09] dark:bg-[#211e1b] dark:shadow-black/40 sm:p-10">
        <section>
          <Link to="/draw" className="mb-10 inline-flex items-center gap-3 font-semibold tracking-[-0.03em]">
          ...
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm leading-6 text-stone-500 dark:text-stone-400">
              Save canvases and collaborate in real time.
            </p>
          </div>
